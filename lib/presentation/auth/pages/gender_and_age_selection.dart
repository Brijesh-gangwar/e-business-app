import 'package:e_business/common/bloc/button/button_state.dart';
import 'package:e_business/common/bloc/button/button_state_cubit.dart';
import 'package:e_business/common/helper/bottomsheet/app_bottomsheet.dart';
import 'package:e_business/core/configs/theme/app_colors.dart';
...
import 'package:e_business/presentation/auth/bloc/age_selection_cubit.dart';
import 'package:e_business/presentation/auth/bloc/ages_display_cubit.dart';
import 'package:e_business/presentation/auth/bloc/gender_selection_cubit.dart';
import 'package:e_business/presentation/auth/widgets/ages.dart';
  ...
  Widget _age() {
    return BlocBuilder<AgeSelectionCubit,String>(
      ...
      return GestureDetector(
        onTap: (){
          // Ensure the AgesDisplayCubit is properly initialized before displaying the bottom sheet
          context.read<AgesDisplayCubit>().displayAges();
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Text(
                state.isNotEmpty ? state : 'Select your age',
                style: const TextStyle(
                  fontSize: 16,
                  color: Colors.black,
                ),
